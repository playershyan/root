...
export const countries: Country[] = [
  ...
  { name: "Virgin Islands (US)", code: "VI", dialCode: "1340", flag: "🇻🇮" },
...
export const getDefaultCountry = (): Country => {
  // Always default to Sri Lanka for this platform
  return countries.find(country => country.code === 'LK') || countries[0]
}

// Get country from localStorage or default to Sri Lanka
export const getSavedCountry = (): Country => {
...
export const saveCountry = (country: Country): void => {
